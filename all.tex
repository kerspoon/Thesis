...
1. Change the power output of each generating unit that is designated as renewable by an amount that correlated with the probabilities in \cite{XXX}. This represents the error in wind forecasting. Although to some extent the errors for each site will cancel out in terms of the total power generated the difference will have to be made up by the conventional generators.
...
As discussed in the introductory chapters many studies have looked at a penetration of wind such that on average 20 \% of the power come from renewable generators. This seems like a suitable figure for this work.

\todo{maybe other penetrations 10\%, 40\%?}

\todo{

which generating units have I picked to be unscheduleable
