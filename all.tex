...
While the program was being developed unit-test were programmed to run every time the code was, that was if any change I had made broke anything I would find out straight away.

The extract of code below makes sure that the individual function \texttt{quantised\_01} does what I expect it to on a few hand worked examples.
...
occurring such as CROW failures \cite{see XXX the Monte Carlo description in this chapter}. These effects should be dwarfed by the overall
