...
described by David Thomas et al. in Pragmatic Unit Testing \cite{XXX}:
...
The code for this is given in Appendix \cite{lbl_sec_code}.
...
As they are very different code paths for the different options given to
main.py the output of profiling is completely different for different uses. Because of this
...
the focus of the optimisation should focus on just those 23.
