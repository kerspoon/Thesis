...
\todo{
say again how it was calculated and what that represents. 
min/max/mode/median for forecast error, 
}

\todo{
table of forecast error frequencies.
image of forecast error frequencies
}
...
\todo{
table, image of freq
how many gen, line, bus.
how does that translate to the real world. how often does an n-x occur.
...
excerpt from both sample file and analysis.
total number of fail cases.
how many were bus fails, \#line \#gen
see how it compares to a probability list of contingencies n long.
n-1 as a predictor of p(acc)
